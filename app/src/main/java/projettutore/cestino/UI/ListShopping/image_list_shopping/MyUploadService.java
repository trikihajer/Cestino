package projettutore.cestino.UI.ListShopping.image_list_shopping;
...
import projettutore.cestino.UI.parametre.categorie.AjouterCategorieFragment;
...
public class MyUploadService extends MyBaseTaskService {
    ...
    private void showUploadFinishedNotification(@Nullable Uri downloadUrl, @Nullable Uri fileUri) {
        ...
        Intent intent = new Intent(this, Add_list_shopping.class)
                .putExtra(EXTRA_DOWNLOAD_URL, downloadUrl)
                .putExtra(EXTRA_FILE_URI, fileUri)
        ...
        int icon = success ? R.drawable.ic_add_box : R.drawable.ic_action_expand;
